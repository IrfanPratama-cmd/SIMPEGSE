    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 offset-sm-2">
                        <div class="mt-3 float-sm-end">
                            ...
                            <p class="font-13"><strong>Golongan Guru : </strong> <span class="float-end">{{ $gaji->pegawai->golongan_guru }}</span></p>
                                ...
                                <tbody>
                                      ...
                                      @if ($data->status == "Dibayar")
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">:</td>
                                                <td>Rp. {{ number_format($data->tunjangan_pasangan) }} </td>
                                            </tr>
                                            <tr>
                                                <td width="40%"> Tunjangan Anak </td>
                                                <td width="25%">:</td>
                                                <td>Rp. {{ number_format($data->tunjangan_anak) }} </td>
                                            </tr>
                                            <tr>
                                                <td width="40%"> Tunjangan Pangan </td>
                                                <td width="25%">:</td>
                                                <td>Rp. {{ number_format($data->tunjangan_pangan) }} </td>
                                            </tr>
                                            <tr>
                                      ...
                                      @else
                                            ...
                                            <tr>
                                                <td width="40%"> Tunjangan Pangan </td>
                                                <td width="25%">:</td>
                                                <td>Rp. {{ number_format($tunjangan_pangan) }} </td>
                                            </tr>
                                            <tr>
                                                <td width="40%"> <h4>Total Gaji</h4> </td>
                                                <td width="25%"><h4>:</h4></td>
                    ...
                    <div class="d-print-none mt-4">
                        <div class="text-end">
                            @if(auth()->user()->role == "Admin")
                                <a href="/downloadGajiPegawai/{{ Crypt::encrypt($gaji->id) }}" class="btn btn-primary"><i class="mdi mdi-printer"></i> Print</a>
                ...
                <div class="d-print-none mt-4">
                    <div class="text-end">
                        <a href="/bayarGajiPegawai/{{ Crypt::encrypt($gaji->id) }}" class="btn btn-success"><i class="mdi mdi-cash"></i> Bayar</a>
                    </div>
                </div>   
                @endif
                <!-- end buttons -->
