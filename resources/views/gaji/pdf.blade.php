  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        ...
        <div>Jabatan       : {{ $jabatan->nama_jabatan }}</div>
        <div>Golongan Guru : {{ $gaji->pegawai->golongan_guru }}</div>
    ...
    <main>
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td width="40%" class="service">Tunjangan Pangan</td>
            <td width="25%" class="desc">:</td>
            <td class="unit">Rp. {{ number_format($tunjangan_pangan) }}</td>
          </tr>
          {{-- <tr>
