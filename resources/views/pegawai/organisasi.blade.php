...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h2>Riwayat Organisasi {{ $pegawai->nama_lengkap }}</h2>
        </div>
    </div>
</div>   
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="/riwayatorganisasi/{{Crypt::encrypt($pegawai->id) }}" class="nav-link active">
                            Riwayat Organisasi
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a href="/seminar/{{Crypt::encrypt($pegawai->id) }}" class="nav-link">
                           Riwayat Seminar
                      </a>
                  </li>
                </ul> <!-- end nav-->
                ...
                <ul class="list-group my-2 col-12">
                   <a href="/detailOrganisasiPegawai/{{  Crypt::encrypt($o->id) }}">
