        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-group my-2">
                    <a href="/detailAnak/{{  Crypt::encrypt($a->id) }}">
                     <li class="list-group-item btn-primary d-flex justify-content-between align-items-center" >
                         {{$a->nama_anak}}

                         <form action="/hapusAnak/{{  Crypt::encrypt($a->id) }}" method="post" class="d-flex col-1">
                            @method('delete')
                            @csrf
                ...
                <a href="/tambahAnak" class="btn btn-info"><i class="mdi mdi-account-edit me-1"></i>Tambah</a>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
</div>
