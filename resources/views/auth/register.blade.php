                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="/register">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="fullname" @error('name') is-invalid @enderror name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Enter your name" required>
                                        @error('name')
                                    ...
                                    {{-- <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="fullname" @error('nama_instansi') is-invalid @enderror name="nama_instansi" value="{{ old('nama_instansi') }}" required autocomplete="name" autofocus placeholder="Masukkan Nama Instansi" required>
                                        @error('nama_instansi')
                                        <div class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="email" id="emailaddress"  @error('email') is-invalid @enderror name="email" value="{{ old('email') }}" required autocomplete="email" required placeholder="Enter your email">
                                    ...
                                    {{-- <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm your password">
                                            <div class="input-group-text" data-password="false">
                                                <span class="password-eye"></span>
                                            </div>
                                        </div>
