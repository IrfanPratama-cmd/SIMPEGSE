              ...
              <div class="row ">
                <form action="/simpanGajiPNS" method="POST">
                  ...
                  <div class="col-lg-12">
                          ...
                          <input type="hidden" name="gaji_pokok" value="{{ $gaji->skhpppk->gaji_pppk  }}">

                          <div class="mb-3">
                              <label for="example-email" class="form-label">Gaji Pokok</label>
                              <input type="text" id="example-email" class="form-control" value="Rp. {{ number_format($gaji->skhpppk->gaji_pppk )  }}" readonly>
                          </div>  
                          
                          <div class="mb-3">
                            <label for="example-email" class="form-label">Golongan PPPK</label>
                            <input type="text" id="example-email" class="form-control" value="{{ $gaji->skhpppk->pppk->golongan_pppk }}" readonly>
                        </div>
