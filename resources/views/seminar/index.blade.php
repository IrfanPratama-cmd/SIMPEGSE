        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    ...
                    <li class="nav-item">
                      <a href="/seminar" class="nav-link active">
                           Riwayat Seminar
                      </a>
                  </li>
                </ul> <!-- end nav-->
                ...
                <ul class="list-group my-2 col-12">
                   <a href="/detailSeminar/{{  Crypt::encrypt($s->id) }}">
                    <li class="list-group-item btn-primary d-flex justify-content-between align-items-center">
                        {{$s->nama_seminar}}
                    
                        <form action="/hapusSeminar/{{  Crypt::encrypt($s->id) }}" method="post" class="d-flex col-1">
                            @method('delete')
                            @csrf
                ...
                <a href="/tambahSeminar" class="btn btn-info"><i class="mdi mdi-account-edit me-1"></i>Tambah</a>
