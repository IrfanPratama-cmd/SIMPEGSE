    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h2 class="text-info">File Manager Siswa</h2>
                <hr>
                                        ...
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <div class="avatar-sm">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            <a class="dropdown-item" href="/downloadFileSiswa/{{ $d->TMdokumen->folder }}/{{ $d->nama_file }}"><i class="mdi mdi-download me-2 text-muted vertical-middle"></i>Download</a>
                                                ...
                                                <div class="col ps-0">
                                                    ...
                                                    <a href="/downloadFileSiswa/{{ $d->TMdokumen->folder}}/{{ $d->nama_file }}" class="text-muted fw-bold">{{ Str::limit($d->nama_file, 20) }}</a>
