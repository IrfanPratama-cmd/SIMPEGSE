        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="/dokumenManager" class="nav-link active">
                            Pegawai
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/dokManagerSiswa" class="nav-link">
                            Siswa
                        </a>
                    </li>
                </ul> <!-- end nav-->
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="app-search">
                        <form action="/cariDokManager" method="GET">
                            <div class="mb-2 position-relative">
                                <input type="text" class="form-control" name="caridok" value="{{ old('caridok') }}" placeholder="Search files...">
                                        ...
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ps-0">
                                                    ...
                                                    <a href="/allDokumen/{{ Crypt::encrypt($d->id) }}" class="text-muted fw-bold">{{ Str::limit($d->folder, 20) }}</a>
                                                    {{-- <p class="mb-0 font-13">{{ number_format($d->size / 1048576, 2) . ' MB' }}</p> --}}
                                                    <p class="mb-0 font-13">{{ $d->tanggal }}</p>
                                                </div>
                                            </div> <!-- end row -->
                                        </div> <!-- end .p-2-->
                                    </div> <!-- end col -->
