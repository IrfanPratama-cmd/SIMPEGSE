    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <!-- File Upload -->
                <form action="/updateFile/{{ Crypt::encrypt($dokumen->id) }}" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews"
                    ...
                    {{-- <div class="fallback">
                        <input name="nama_file" type="file" multiple />
                    </div>
                    ...
                    <div class="d-none" id="uploadPreviewTemplate">
                        ...
                        <div class="col-4 card mt-1 mb-0 shadow-none border">
