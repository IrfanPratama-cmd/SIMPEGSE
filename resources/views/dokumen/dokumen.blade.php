                    ...
                    <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="5%"><h4>:</h4></td>
                            <td><h4><a href="/downloadFile/{{ $dokumen->folder }}/{{ $nama_file }}">{{ $nama_file }}</a> </h4></td>
                          </tr>
                        </tbody>
        
                      </table>

                      <a href="/editFile/{{ Crypt::encrypt($id) }}" class="btn btn-info">Edit File</a>
                @else
                <!-- File Upload -->
                <form action="/uploadDokumen" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews"
