...
<h1>Presensi Pegawai {{ $pegawai->nama_lengkap }}</h1>
<hr>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="/rekapPresensiAdmin" class="nav-link active">
                            Rekap Bulanan
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class=" d-lg-block col-4">
                    <form action="/presensiPegawaiBulan/{{ Crypt::encrypt($pegawai->id)  }}" method="GET">
                        @csrf
                        <div class="input-group">
                            <select class="form-select" name="bulan" id="example-select" value="{{ old('bulan') }}">
